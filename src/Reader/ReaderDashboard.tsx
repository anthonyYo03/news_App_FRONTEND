...
import GetLastFiveImportantNewsForReader from '../RandomReader/News/GetLastFiveImportantNewsForReader';
...
export default function News() {
  ...
  return (
    <div className="news-page">
      ...
      <GetLastFiveImportantNewsForReader />
      ...
      <div className="news-container">
        {loading ? (
          ...
          <div className="news-grid" >
            {news.map((newsItem) => (
              <div key={newsItem.news_id} className="news-card" style={{cursor:'pointer'}} onClick={()=>{navigate(`/readerNews/${newsItem.news_id}`)}}>
